...
class PackageInstallHammer5(PackageInstallation):
  ...
  dnf reinstall -y https://github.com/TPC-Council/HammerDB/releases/download/v5.0/hammerdb-5.0-1.el8.x86_64.rpm
else
...
if rpm -q --quiet oracle-instantclient-basic-21.18.0.0.0-1.el8.x86_64; then
  echo "hammerdb-5.0-1.el8.x86_64 is installed. - reinstalling"
   dnf reinstall -y https://download.oracle.com/otn_software/linux/instantclient/2118000/oracle-instantclient-basic-21.18.0.0.0-1.el8.x86_64.rpm
else
  echo "hammerdb-5.0-1.el8.x86_64 is not installed."
...
if rpm -q --quiet oracle-instantclient-sqlplus-21.18.0.0.0-1.el8.x86_64; then
  echo "hammerdb-5.0-1.el8.x86_64 is installed - reinstalling."
  dnf reinstall -y https://download.oracle.com/otn_software/linux/instantclient/2118000/oracle-instantclient-sqlplus-21.18.0.0.0-1.el8.x86_64.rpm
else
  echo "hammerdb-5.0-1.el8.x86_64 is not installed."
