...
sudo dnf install -y  /tmp/glibc-2.28-251.el8.x86_64.rpm

sudo dnf install -y bc binutils compat-openssl10 elfutils-libelf glibc glibc-devel ksh libaio libXrender libX11 \
...
sudo dnf install -y /tmp/oracle-database-preinstall-21c-1.0-1.el8.x86_64.rpm
